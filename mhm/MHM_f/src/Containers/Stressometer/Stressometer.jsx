...
import '../Stressometer/stressometer.css';
        ...
        return (
          <div className="poschange">
            <label htmlFor="anxiety_level" className="form-label">
              <img src={img1} style={{ objectFit:"cover", width:"100%", height:"100%",position:"relative"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%"}} placeholder="Anxiety level(1-22)" 
              type="number"
              id="anxiety_level"
              name="anxiety_level"
            ...
            />
          <p className="txtclr">Anxiety is a common mental health condition characterized by feelings of unease, worry, and fear. Check you anxiety level<a href="https://www.hiv.uw.edu/page/mental-health-screening/gad-7" target="_blank" style={{color:'yellow'}}>Here</a>.</p>
          </div>
      ...
      case 2:
        return (
          <div>
            ...
            <img src={img2} style={{ objectFit:"cover", width:"100%", height:"100%", display:"flex"}}/>
              
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Self Esteem(0-31)" 
              type="number"
              id="self_esteem"
              name="self_esteem"
            ...
            />
               ...
               <p className="txtclr">Self-esteem refers to the overall opinion and perception one has of oneself. It is the subjective evaluation of our own worth, capabilities, and value as individuals.<a href="https://wwnorton.com/college/psych/psychsci/media/rosenberg.htm" target="_blank" style={{color:'yellow'}}>Here</a>.</p>
      ...
      case 3:
        return (
          <div>
            ...
            <img src={img3} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Mental Health History(0-1)"
              type="number"
          ...
          <p className="txtclr">Mental health history refers to an individual's personal journey and experiences with mental well-being and any related conditions or challenges they have encountered.</p>
      ...
      case 4:
        return (
          <div>
            ...
            <img src={img4} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Depression(0-28)"
              type="number"
              id="depression"
              name="depression"
            ...
            <p className="txtclr">Depression is a mental health disorder characterized by persistent feelings of sadness, hopelessness, and a loss of interest or pleasure in activities.<a href="/" style={{color:'yellow'}}>Here</a>.</p>
      ...
      case 5:
        return (
          <div>
            ...
            <img src={img5} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Headache(0-5)"
              type="number"
              id="headache"
              name="headache"
          ...
          <p className="txtclr">A headache is a common condition characterized by pain or discomfort in the head or neck region. It is one of the most prevalent health complaints and can range from mild to severe in intensity.</p>
      ...
      case 6:
        return (
          <div>
            ...
            <img src={img6} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Blood Pressure(1-3)"
              type="number"
              id="blood_pressure"
              name="blood_pressure"
          ...
          <p className="txtclr">Blood pressure refers to the force exerted by circulating blood against the walls of blood vessels. It is an essential measure of cardiovascular health.</p>
      ...
      case 7:
        return (
          <div>
            ...
            <img src={img7} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Sleep quality(1-5)"
              type="number"
              id="sleep_quality"
              name="sleep_quality"
            ...
            <p className="txtclr">Sleep quality refers to the overall effectiveness and restfulness of one's sleep.<a href="http://www.stopbang.ca/patient/screening.php" style={{color:'yellow'}}>Here</a></p>
      ...
      case 8:
        return (
          <div>
            ...
            <img src={img8} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Breathing Problem(1-5)"
              type="number"
            ...
            <p className="txtclr">Breathing problems refer to difficulties or abnormalities in the process of inhaling and exhaling air.</p>
      ...
      case 9:
        return (
          <div>
            ...
            <img src={img9} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Noise level(1-5)"
              type="number"
              id="noise_level"
              name="noise_level"
            ...
            <p className="txtclr">Noise level refers to the intensity or volume of sound in a particular environment.</p>
      ...
      case 10:
        return (
          <div>
            ...
            <img src={img10} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"1005",onClick:"noChange"}} placeholder="Living Conditions(1-5)"
              type="number"
            ...
            <p className="txtclr">Living conditions refer to the overall quality and standards of the physical, social, and environmental aspects in which individuals reside.</p>
      ...
      case 11:
        return (
          <div>
            ...
            <img src={img11} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Safety(1-5)"
              type="number"
              id="safety"
              name="safety"
            ...
            <p className="txtclr">Safety refers to the state of being free from harm, danger, or risk. It encompasses various aspects of personal, physical, and psychological well-being.</p>
      ...
      case 12:
        return (
          <div>
            ...
            <img src={img12} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Basic Needs(1-5)"
              type="number"
              id="basic_needs"
              name="basic_needs"
            ...
            <p className="txtclr">These needs typically include access to clean air, water, and nutritious food to sustain physical health.</p>
      ...
      case 13:
        return (
          <div>
            ...
            <img src={img13} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Academice Performance(1-5)"
              type="number"
            ...
            <p className="txtclr">Academic performance refers to the level of achievement and success that an individual demonstrates in their educational pursuits.</p>
      ...
      case 14:
        return (
          <div>
            ...
            <img src={img14} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Study Load(1-5)"
              type="number"
              id="study_load"
              name="study_load"
            ...
            <p className="txtclr">Study load refers to the amount of academic coursework and learning activities that a student is expected to complete within a given period.</p>
      ...
      case 15:
        return (
          <div>
            ...
            >
              <img src={img15} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Teacher Student Relationship(1-5)"
              type="number"
            ...
            <p className="txtclr">The teacher-student relationship is a crucial and dynamic bond that plays a significant role in education.</p>
      ...
      case 16:
        return (
          <div>
            ...
            <img src={img16} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Future Career Concerns(1-5)"
              type="number"
            ...
            <p className="txtclr">Future career concerns refer to the apprehensions and considerations individuals have regarding their professional paths and choices.</p>
      ...
      case 17:
        return (
          <div>
            ...
            <img src={img17} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Social Support(1-5)"
              type="number"
              id="social_support"
              name="social_support"
            ...
            <p className="txtclr">Social support refers to the network of relationships, resources, and emotional assistance that individuals receive from their social connections, such as family, friends, peers, and community.</p>
      ...
      case 18:
        return (
          <div>
            ...
            <img src={img18} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Peer Pressure(1-5)"
              type="number"
              id="peer_pressure"
              name="peer_pressure"
            ...
            <p className="txtclr">Peer pressure refers to the influence and impact that individuals within a similar age group or social circle can have on each other's thoughts, behaviors, and decision-making.</p>
      ...
      case 19:
        return (
          <div>
            ...
            <img src={img19} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Extracurricular Activities(1-5)"
              type="number"
            ...
            <p className="txtclr">Extracurricular activities refer to the activities and pursuits that students engage in outside of their regular academic curriculum.</p>
      ...
      case 20:
        return (
          <div>
            ...
            <img src={img20} style={{ objectFit:"cover", width:"100%", height:"100%"}}/>
            </label>
            <input style={{border:"solid 2px",width:"100%",onClick:"noChange"}} placeholder="Bullying(1-3)"
              type="number"
              id="bullying"
              name="bullying"
            ...
            <p className="txtclr">Bullying refers to repeated aggressive behavior that involves an imbalance of power, where one individual or group intentionally harms, harasses, or intimidates another person.</p>
